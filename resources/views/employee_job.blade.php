...
@section('body')
	<h1 style="text-align: center;">Your All Live Job List<h1><hr>
		...
		@foreach($data as $value)
			<tr>
				...
				<td>
					...
					<a href="/jobss_delete/{{ $value->id }}"><button style="border: 1px solid black;, background-color: red;">Delete</button>
					</a>
				</td>
			</tr>
		@endforeach
