	...
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
		...
		@foreach($data as $value)
			<tr>
				...
				<td><a href="/accept/{{ $value->id }}"><button style="border: 1px solid black;background-color: lightgreen;">Accept</button></a>&nbsp;&nbsp;<a href="/delete/{{ $value->id }}"><button style="border: 1px solid black;background-color: red;">Delete</button></a>
				</td>
			</tr>
		@endforeach
		</table>
