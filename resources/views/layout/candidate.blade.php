<html>
	<head>
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('css/candidate_home_style.css')}}">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/candidateHome">
        <i class="fa fa-home" aria-hidden="true"></i>
          <span>Homepage</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/candidateInfo">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/showCV">
          <i class="fa fa-plus-circle" aria-hidden="true"></i>
          <span>See CV</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/see_all_job">
          <i class="fa fa-info-circle" aria-hidden="true"></i>
          <span>See All Job</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/see_applied_job">
          <i class="fa fa-info-circle" aria-hidden="true"></i>
          <span>Your Applied Job List</span></a>
      </li>
