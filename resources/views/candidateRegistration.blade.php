...
@section('body')
    ...
    <!------ Include the above in your HEAD tag ---------->
            ...
            <div class="container">
                <form method="post" action="\candidate_register" class="form-horizontal" role="form">
                    <h2>Registration</h2>
                    <br><br>
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        <label for="companyName" class="col-sm-3 control-label">Your Degree*</label>
                        <div class="col-sm-9">
                            <input type="text" id="education" placeholder="Your Educational Bakground" class="form-control" name="education" >
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="companyName" class="col-sm-3 control-label">Your Skill*</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="companyName" class="col-sm-3 control-label">Your City*</label>
                        <div class="col-sm-9">
                            <input type="text" id="location" placeholder="Your City Here" class="form-control" name="location" >
                        </div>
                    </div>
                     <!-- /.form-group -->
                    <div class="form-group">
