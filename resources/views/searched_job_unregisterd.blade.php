@extends('layout/home')
@section('body')
	<link rel="stylesheet" type="text/css" href="{{ asset('css/job_list_unregisterd.css') }}">
	...
	@foreach($job as $value)
		<div class="job_list">
			...
			<a href="/details_job_unregisterd/{{ $value->id }}"><button class="btn1">See Details</button></a>
